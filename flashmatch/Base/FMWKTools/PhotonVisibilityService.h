...
namespace phot{
  ...
  public:
    ...
    PhotonVisibilityService(const std::string library="PhotonLibrary-20200816.root");
    ...
    static PhotonVisibilityService& GetME(std::string filename="PhotonLibrary-20200816.root")
    {
